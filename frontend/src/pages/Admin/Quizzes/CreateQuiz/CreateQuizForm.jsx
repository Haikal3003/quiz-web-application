...
const CreateQuizForm = ({ onSaveQuiz }) => {
  ...
  const [questions, setQuestions] = useState([{ question: '', options: [''], correctAnswer: null, showOptions: true }]);
  ...
  return (
    <form id="create-quiz-form" className="relative w-full h-auto" onSubmit={handleSubmit}>
