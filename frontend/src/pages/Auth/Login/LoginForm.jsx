    ...
    <form id="login-form" className="relative max-w-[75%] w-full h-full flex flex-col justify-center">
      <div className="input-container">
        ...
        <div id="input-div" className="max-w-full w-full bg-slate-100">
          <input id="email-input" type="email" placeholder="Enter email..." name="email" value={email} onChange={setEmail} />
        </div>
      </div>
      ...
      <div className="input-container relative">
        ...
        <div id="input-div" className="max-w-full w-full bg-slate-100 flex  ">
          <input id="password-input" type={visible ? 'text' : 'password'} placeholder="Enter password..." name="password" value={password} onChange={setPassword} />
